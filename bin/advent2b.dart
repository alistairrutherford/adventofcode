...
var CAPTCHA =  [414,382,1515,319,83,1327,116,391,101,749,1388,1046,1427,105,1341,1590,
...
main(List<String> arguments) {
  ...
  for (int y = 0; y < GRID_Y; y++) {
    ...
    for (int x = 0; x < GRID_X; x++) {
      ...
      int valueIndex = x + (y * GRID_X);
      int value = CAPTCHA[valueIndex];

      for (int z = x + 1; z < GRID_X; z++) {
        int compIndex = z + (y * GRID_X);
        int comp = CAPTCHA[compIndex];

        int modulus = 0;
        int divide = 0;
        if (value > comp) {
          modulus = value % comp;
          divide = (value / comp).toInt();
        } else {
            modulus = comp % value;
            divide = (comp / value).toInt();
        }
